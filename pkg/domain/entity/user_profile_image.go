...
func (q userProfileImageQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UserProfileImage, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: failed to execute a one query for user_profile_image")
	}
...
func (q userProfileImageQuery) All(ctx context.Context, exec boil.ContextExecutor) (UserProfileImageSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "entity: failed to assign all query results to UserProfileImage slice")
	}
...
func (q userProfileImageQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to count user_profile_image rows")
	}
...
func (q userProfileImageQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entity: failed to check if user_profile_image exists")
	}
...
func FindUserProfileImage(ctx context.Context, exec boil.ContextExecutor, iD uint, selectCols ...string) (*UserProfileImage, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: unable to select from user_profile_image")
	}
...
func (o *UserProfileImage) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no user_profile_image provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to insert into user_profile_image")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to populate default values for user_profile_image")
	}
...
func (o *UserProfileImage) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("entity: unable to update user_profile_image, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update user_profile_image row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by update for user_profile_image")
	}
...
func (q userProfileImageQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all for user_profile_image")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected for user_profile_image")
	}
...
func (o UserProfileImageSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all in userProfileImage slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected all in update all userProfileImage")
	}
	return rowsAff, nil
}
...
func (o *UserProfileImage) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no user_profile_image provided for upsert")
	}
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("entity: unable to upsert user_profile_image, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert for user_profile_image")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to retrieve unique values for user_profile_image")
	}
...
func (o *UserProfileImage) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("entity: no UserProfileImage provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete from user_profile_image")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by delete for user_profile_image")
	}
...
func (q userProfileImageQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("entity: no userProfileImageQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from user_profile_image")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by deleteall for user_profile_image")
	}
...
func (o UserProfileImageSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from userProfileImage slice")
	}
...
func (o *UserProfileImage) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("entity: no UserProfileImage provided for reload")
	}
...
func (o *UserProfileImageSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("entity: empty UserProfileImageSlice provided for reload all")
	}
...
func (o *UserProfileImageSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to reload all in UserProfileImageSlice")
	}
...
func UserProfileImageExists(ctx context.Context, exec boil.ContextExecutor, iD uint) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "entity: unable to check if user_profile_image exists")
	}
