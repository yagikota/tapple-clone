...
func (q roomUserQuery) One(ctx context.Context, exec boil.ContextExecutor) (*RoomUser, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: failed to execute a one query for room_users")
	}
...
func (q roomUserQuery) All(ctx context.Context, exec boil.ContextExecutor) (RoomUserSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "entity: failed to assign all query results to RoomUser slice")
	}
...
func (q roomUserQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to count room_users rows")
	}
...
func (q roomUserQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entity: failed to check if room_users exists")
	}
...
func FindRoomUser(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*RoomUser, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: unable to select from room_users")
	}
...
func (o *RoomUser) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no room_users provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to insert into room_users")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to populate default values for room_users")
	}
...
func (o *RoomUser) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("entity: unable to update room_users, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update room_users row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by update for room_users")
	}
...
func (q roomUserQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all for room_users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected for room_users")
	}
...
func (o RoomUserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all in roomUser slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected all in update all roomUser")
	}
	return rowsAff, nil
}
...
func (o *RoomUser) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no room_users provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("entity: unable to upsert room_users, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert for room_users")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to retrieve unique values for room_users")
	}
...
func (o *RoomUser) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("entity: no RoomUser provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete from room_users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by delete for room_users")
	}
...
func (q roomUserQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("entity: no roomUserQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from room_users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by deleteall for room_users")
	}
...
func (o RoomUserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from roomUser slice")
	}
...
func (o *RoomUser) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("entity: no RoomUser provided for reload")
	}
...
func (o *RoomUserSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("entity: empty RoomUserSlice provided for reload all")
	}
...
func (o *RoomUserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to reload all in RoomUserSlice")
	}
...
func RoomUserExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "entity: unable to check if room_users exists")
	}
