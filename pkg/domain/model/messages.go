...
var (
	messageAllColumns            = []string{"id", "user_id", "room_id", "content", "is_read", "created_at", "updated_at", "deteled_at"}
	messageColumnsWithoutDefault = []string{"user_id", "room_id", "content", "deteled_at"}
	messageColumnsWithDefault    = []string{"id", "is_read", "created_at", "updated_at"}
...
func (q messageQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Message, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for messages")
	}
...
func (q messageQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to count messages rows")
	}
...
func (q messageQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "model: failed to check if messages exists")
	}
...
// SetUserG of the message to the related item.
// Sets o.R.User to related.
// Adds o to related.R.Messages.
// Uses the global database handle.
func (o *Message) SetUserG(ctx context.Context, insert bool, related *User) error {
...
// SetRoomG of the message to the related item.
// Sets o.R.Room to related.
// Adds o to related.R.Messages.
// Uses the global database handle.
func (o *Message) SetRoomG(ctx context.Context, insert bool, related *Room) error {
...
func FindMessageG(ctx context.Context, iD int64, selectCols ...string) (*Message, error) {
...
func FindMessage(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Message, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: unable to select from messages")
	}
...
func (o *Message) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("model: no messages provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to insert into messages")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to populate default values for messages")
	}
...
func (o *Message) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("model: unable to update messages, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update messages row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by update for messages")
	}
...
func (q messageQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all for messages")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected for messages")
	}
...
func (o *Message) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("model: no messages provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("model: unable to upsert messages, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert for messages")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to retrieve unique values for messages")
	}
...
func (o *Message) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete from messages")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by delete for messages")
	}
...
func (q messageQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from messages")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by deleteall for messages")
	}
...
func MessageExistsG(ctx context.Context, iD int64) (bool, error) {
...
func MessageExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "model: unable to check if messages exists")
	}
